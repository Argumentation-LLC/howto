...
To add a reason box below and connected to a desired box, select the desired box and use either “Add reason” button in the control panel at the top of the Argumentation workspace or press Shift+Alt+R.
...
Objections work the same way. The “Add objection” button is also in the control panel at the top of the Argumentation workspace. The key command to add an objection is Shift+Alt+O.
...
2. Click the ‘Add co-premise’ button in the control panel at the top of the Argumentation workspace or use the key command Alt+Shift+C. This adds another reason inside the reason group box of the selected reason or objection. It will appear, to the right of the one you selected when you used the add co-premise function.
